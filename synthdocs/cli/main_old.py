...
def fields(document_type):
    ...
    try:
        ...
        for field in config['required_fields']:
            table.add_row(field, "", "Required")
        
        for field in config['optional_fields']:
            table.add_row(field, "Ë", "Optional")
...
def generate(document_type, data, output_format, output, batch):
    ...
    try:
        ...
        if batch and isinstance(doc_data, list):
            ...
            console.print(f"  =Ê Size: {file_size:,} bytes")
...
def serve(host, port, reload):
    ...
    try:
        ...
        console.print("=Ö API Documentation: http://localhost:8000/docs")
