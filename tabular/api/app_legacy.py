# Tabular Synthetic Data API - Legacy Version
"""
Inferloop Tabular Synthetic Data REST API (Legacy)

This is the legacy version of the API. For the unified infrastructure version,
use app_unified.py instead.
"""
